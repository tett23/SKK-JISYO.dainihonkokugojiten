...
![辞書ごとの正解率と 95% 信頼区間（v1.0.7）](docs/accuracy/v1.0.7.svg)

| 辞書（v1.0.7）                      | 正しい / 抜き取り | 正解率 | 95% 信頼区間 |
| ----------------------------------- | ----------------: | -----: | -----------: |
| `SKK-JISYO.dainihonkokugojiten.noL` |       1995 / 2000 |  99.8% | 99.4%〜99.9% |

- 抜き取りの条件: 各辞書から 2000 件（シード値 2464935758）（[docs/accuracy/v1.0.7/sample.json](docs/accuracy/v1.0.7/sample.json)）
- シード値の事前記録: 確認済み（シード値の記録 2b204db 2026-09-26 → 判定の記録 2421980 2026-09-26）
- 人の確認: 必要だが未実施（理由: OCR 済みの入力が v1.0.6 と異なるか、記録が無い、v1.0.6 から規則が変わった（src/recheck.ts））
- 注意: L 除外辞書だけを評価した（検証済み・未検証の辞書は測っていない）。多数決の規則をコミットした後に、過去の標本と別のシード値で抜き取った

<!-- accuracy:v1.0.7:end -->

<!-- accuracy:v1.0.6:start -->

### v1.0.6

![辞書ごとの正解率と 95% 信頼区間（v1.0.6）](docs/accuracy/v1.0.6.svg)

| 辞書（v1.0.6）                      | 正しい / 抜き取り | 正解率 |  95% 信頼区間 |
| ----------------------------------- | ----------------: | -----: | ------------: |
| `SKK-JISYO.dainihonkokugojiten.noL` |       1999 / 2000 | 100.0% | 99.7%〜100.0% |

- 抜き取りの条件: 各辞書から 2000 件（シード値 878458409）（[docs/accuracy/v1.0.6/sample.json](docs/accuracy/v1.0.6/sample.json)）
- シード値の事前記録: 確認済み（シード値の記録 81a6401 2026-09-25 → 判定の記録 54a0df5 2026-09-25）
- 人の確認: 必要だが未実施（理由: v1.0.5 から規則が変わった（src/align.ts、src/cleanse.ts））
- 注意: L 除外辞書だけを評価した（検証済み・未検証の辞書は測っていない）。清濁の統計の規則は過去の判定（誤り 213 件）を見て決めたが、この標本はそれと別のシード値で、規則をコミットした後に抜き取った

<!-- accuracy:v1.0.6:end -->

<!-- accuracy:v1.0.5:start -->

### v1.0.5

![辞書ごとの正解率と 95% 信頼区間（v1.0.5）](docs/accuracy/v1.0.5.svg)

| 辞書（v1.0.5）                      | 正しい / 抜き取り | 正解率 | 95% 信頼区間 |
| ----------------------------------- | ----------------: | -----: | -----------: |
| `SKK-JISYO.dainihonkokugojiten.noL` |       1995 / 2000 |  99.8% | 99.4%〜99.9% |

- 抜き取りの条件: 各辞書から 2000 件（シード値 1292785526）（[docs/accuracy/v1.0.5/sample.json](docs/accuracy/v1.0.5/sample.json)）
- シード値の事前記録: 確認済み（シード値の記録 8394930 2026-09-25 → 判定の記録 ee63092 2026-09-25）
- 人の確認: 必要だが未実施（理由: v1.0.4 から規則が変わった（src/build.ts、src/cleanse.ts））
- 注意: L 除外辞書だけを評価した（検証済み・未検証の辞書は測っていない）

<!-- accuracy:v1.0.5:end -->

<!-- accuracy:v1.0.4:start -->

### v1.0.4

![辞書ごとの正解率と 95% 信頼区間（v1.0.4）](docs/accuracy/v1.0.4.svg)

| 辞書（v1.0.4）                      | 正しい / 抜き取り | 正解率 | 95% 信頼区間 |
| ----------------------------------- | ----------------: | -----: | -----------: |
| `SKK-JISYO.dainihonkokugojiten.noL` |       1990 / 2000 |  99.5% | 99.1%〜99.7% |

- 抜き取りの条件: 各辞書から 2000 件（シード値 511498292）（[docs/accuracy/v1.0.4/sample.json](docs/accuracy/v1.0.4/sample.json)）
- シード値の事前記録: 確認済み（シード値の記録 f56daec 2026-09-25 → 判定の記録 078d6b6 2026-09-25）
- 人の確認: 必要だが未実施（理由: OCR 済みの入力が v1.0.3 と異なるか、記録が無い、v1.0.3 から規則が変わった（src/align.ts、src/cleanse.ts、src/kana.ts、src/recheck.ts））
- 注意: L 除外辞書だけを評価した（検証済み・未検証の辞書は測っていない）。戻す規則は開発用の抜き取り（動詞 150 件など）を見て決めたが、この標本はそれと別のシード値で、規則をコミットした後に抜き取った

<!-- accuracy:v1.0.4:end -->

<!-- accuracy:v1.0.3:start -->

### v1.0.3

![辞書ごとの正解率と 95% 信頼区間（v1.0.3）](docs/accuracy/v1.0.3.svg)

| 辞書（v1.0.3）                      | 正しい / 抜き取り | 正解率 | 95% 信頼区間 |
| ----------------------------------- | ----------------: | -----: | -----------: |
| `SKK-JISYO.dainihonkokugojiten.noL` |       1996 / 2000 |  99.8% | 99.5%〜99.9% |

- 抜き取りの条件: 各辞書から 2000 件（シード値 2774640519）（[docs/accuracy/v1.0.3/sample.json](docs/accuracy/v1.0.3/sample.json)）
- シード値の事前記録: 確認済み（シード値の記録 5e58397 2026-09-25 → 判定の記録 88f29c6 2026-09-25）
- 人の確認: 必要だが未実施（理由: OCR 済みの入力が v1.0.2 と異なるか、記録が無い、v1.0.2 から規則が変わった（src/cleanse.ts、src/recheck.ts））
- 注意: L 除外辞書だけを評価した（検証済み・未検証の辞書は測っていない）。戻す候補の選び方は、未検証にした候補の開発用の抜き取り（420 件）を見て決めたが、この標本はそれと別のシード値で、規則をコミットした後に抜き取った
...
| ----------------------------------- | ----------------: | -----: | -----------: |
| `SKK-JISYO.dainihonkokugojiten.noL` |       1994 / 2000 |  99.7% | 99.3%〜99.9% |
